    ...
    MenuItem top = new ItemBase( "Top", Icons.EV3)
        ...
        .addChild(
            new ItemBase( "System", Icons.EV3)
                ...
                .addDetail(AutoRefreshDetail.getInstance( "system.time", "Time",  "%2$s: %3$s", ""))
                .addDetail(AutoRefreshDetail.getInstance( "system.volt", "Battery",  "%2$s: %3$s", ""))
                .addDetail(AutoRefreshDetail.getInstance( "system.current", "Current",  "%2$s: %3$s", "")))
        .addChild(
